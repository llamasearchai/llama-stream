# Contributing to Llama Stream

Thank you for your interest in contributing to Llama Stream! This document provides guidelines and instructions for contributing to this project.
...
There are many ways to contribute to Llama Stream:
...
2. **Clone your fork**:
   ```bash
   git clone https://github.com/YOUR_USERNAME/llama-stream.git
   cd llama-stream
   ```

3. **Set up the upstream remote**:
   ```bash
   git remote add upstream https://github.com/llamasearchai/llama-stream.git
   ```
...
By contributing to Llama Stream, you agree that your contributions will be licensed under the project's MIT License.
